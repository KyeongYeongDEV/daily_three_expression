...
const expression_delivery_entity_1 = require("../entities/expression-delivery.entity");
let ExpressionDeliveryRepository = class ExpressionDeliveryRepository {
    ...
    async findDeliveriedExpressionsByUid(u_id) {
        return await this.datasource
            .getRepository(expression_delivery_entity_1.ExpressionDeliveryEntity)
            .createQueryBuilder('delivery')
            .leftJoinAndSelect('delivery.expression', 'expression')
            .where('delivery.u_id = :u_id', { u_id })
            .orderBy('delivery.transmitted_at', 'DESC')
            .getMany();
    }
};
